...
- **Frontend Avançado:** Next.js (App Router, Server Actions), TypeScript avançado, design responsivo  
- **Backend em Aprofundamento:** Node.js, Python (FastAPI/Django), MySQL  
